...
\textbf{Thursday}
\begin{itemize}
\item Multivariate normal, part II (cybersecurity application, Gibbs sampling, handling missing data)
\item Introduction to pymc3 (activity)
\item Non-conjugate models:  A racially polarized voting model 
