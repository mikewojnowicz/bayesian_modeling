...
9:07
Tomorrow:
your MCMC stuff (very much ok to take whole day if desired/needed)
(if time) mvn, the second part (conditional conjugacy, inference, missing data)
...
\item Multivariate normal, part I (motivation, fully conjugate models, cybersecurity application)
\end{itemize}
...
\textbf{Wednesday}
\begin{itemize}
\item Multivariate normal, part II (conditionally conjugate model, Gibbs sampler, activity, missing data)
...
\textbf{Friday}
\begin{itemize}
\item Introduction to variational inference
\item pymc3 activity 
