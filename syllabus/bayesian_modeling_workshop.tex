...
\item Why bayes?
\item Introduction to inference (plus activity)
\end{itemize}

\textbf{Tuesday}

\begin{itemize}
\item Introduction to sampling (with activity) 
\end{itemize}

\textbf{Wednesday}
\begin{itemize}
\item Multivariate normal, part I (motivation, cybersecurity application, Gibbs sampler, activity)
\item Multivariate normal, part II (handling missing data)
\item Bayesian linear regression, Part I
\end{itemize}

\textbf{Thursday}
\begin{itemize}
\item 	Bayesian linear regression, Part II (activity,  hierarchical bayesian linear regression)
\item Gradient based sampling 
\end{itemize}
