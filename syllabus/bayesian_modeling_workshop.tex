...
\item Hierarchical Bayesian linear regression
\end{itemize}
...
\item Non-conjugate models: Bayesian logistic regression, Bayesian categorical regression, racially polarized voting model
\end{itemize}
