...
This prior specifies $k$ in terms of the error variance, $k=g \sigma^2$ for some $g$.  There are different methods for setting $g$, although Michael Jordan recommends putting a prior $g \sim \IG(\half, \frac{n}{2})$.
\end{sblock}
